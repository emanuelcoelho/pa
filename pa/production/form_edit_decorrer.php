                  ...
                  <div class="x_title">
                    ...
                    <div class="title_right">
                      <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right">
                        <a href="form_search_decorrer.php" id="button" type="button"  class="btn btn-primary botao" ><i class="fa fa-arrow-left"></i>  Voltar pagina anterior</a>
                      </div>
                    </div>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2"  method="post" action="http://myslimsite/api/formResEdit/allEdit" class="form-horizontal form-label-left" >   
                      ...
                      <?php
                            ...
                            $_SESSION['paginaAnterior'] = 'form_edit_decorrer.php?var='.$id;
                      ?>
