<?php 
  ...
  // verifica se tem permissão para criar mensagem
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <?php
                      ...
                      // grava posicao actual na variavel de sessao
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Enviar mensagem <small>Seleccione o utilizador para o qual pretende enviar a mensagem</small></h2>
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#table').on('click','.botao',function () {
          ...
          var v = $(this).data('id');
          // abre pagina de mandar mensagem        
          if (v != undefined && v != null) {
            window.location = '/pa/production/form_send_messages.php?var=' + v;
          }
        });
      });
    </script>
