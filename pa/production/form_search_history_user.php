...
<html lang="en">
  ...
  <body class="nav-md">
                          ...
                          <tbody>
                            <?php
                              ...
                              while ($row = $result->fetch_assoc()) {
                                 ...
                                 echo '<tr>
                                        <td><button id="button[]" type="button" class="btn btn-primary botaoM" data-id='.$row['id'].'>Histórico mensagens</button>
                                            <button id="button[]" type="button" class="btn btn-primary botaoR" data-id='.$row['id'].'>Histórico reservas</button>
                                        </td>
                                        <td> '.$row['username'].'</td>
                                        <td> '.$row['numero'].'</td> 
                                        <td> '.$row['email'].'</td>  
    ...
    $(document).ready(function(){
     ...
     $(".botaoM").click(function(){ // Click to only happen on announce links

      var v = $(this).data('id');        
      if (v != undefined && v != null) {
          window.location = '/pa/production/form_search_history_messages.php?var=' + v;
      }
       
     });

     $(".botaoR").click(function(){ // Click to only happen on announce links

      var v = $(this).data('id');        
      if (v != undefined && v != null) {
          window.location = '/pa/production/form_search_history_reservas.php?var=' + v;
      }
