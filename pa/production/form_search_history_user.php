  ...
  <body class="nav-md">
    ...
    <script>
      $(document).ready(function(){
        ...
        // ao carregar no botao de mensagens na tabela
        $('#table').on('click','.botaoM',function () {
          // recolhe id do utilizador
          var v = $(this).data('id');
          // abre pagina de historico de mensagens        
          if (v != undefined && v != null) {
            window.location = '/pa/production/form_search_history_messages.php?var=' + v;
          }
        });

        // ao carregar no botao de reservas na tabela
        $('#table').on('click','.botaoR',function () {
          // recolhe id do utilizador
          var v = $(this).data('id');   
          // abre pagina de historico de reservas     
          if (v != undefined && v != null) {
