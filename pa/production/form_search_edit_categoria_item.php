                        ...
                        <table id="table" class="table table-striped table-bordered bulk_action dt-responsive text-center nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <?php
                              ...
                              // recolhe todas as categorias menos a "sem categoria"                              
                              $query = "SELECT * FROM categoria_item WHERE id != '$nocat'";
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#table').on('click','.botao',function () {
          // recolhe id da categoria
          var v = $(this).data('id');  
          // abre pagina para editar categoria      
          if (v != undefined && v != null) {
