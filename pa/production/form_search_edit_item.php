                          ...
                          <thead>
                            ...
                            <tbody>
                              <?php
                                ...
                                // recolhe todos os itens se tiver permissao para ver itens escondidos
                                // recolhe todos os itens visiveis se nao tiver permissao para ver itens escondidos
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#table').on('click','.botao',function () {
          // recolhe id do item
          var v = $(this).data('id');
          // abre pagina para editar o item        
          if (v != undefined && v != null) {
            window.location = '/pa/production/form_edit_item.php?var=' + v;
          }
        });
      });
    </script>
