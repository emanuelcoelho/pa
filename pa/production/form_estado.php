          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registo estado <small>Insira as informações necessárias (campos com <span style="color:red">*</span> são obrigatórios!)</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="http://myslimsite/api/formEst/insertEstado" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
        ...
        $(function() {
          ...
          $(form).submit(function(event) {
            ...
            {  
              ...
              $('#msg_desc').html("Deve preencher este campo de forma válida! Ex: Funcional");  
            }  
            else  
            {  
              ...
              $('#msg_desc').html("");
              $('#msg').html("Estado criado com sucesso!");
              $('#demo-form2').trigger("reset");
              //$('#descricao').val('');
            }
          });
