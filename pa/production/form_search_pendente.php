  ...
  <body class="nav-md">
                        ...
                        <table id="table" class="table table-striped table-bordered bulk_action dt-responsive text-center nowrap" cellspacing="0" width="100%">
                          ...
                          <thead>
                            <tr>                              
                              ...
                              <th class="text-center">Aceitar/Recusar</th>
                            </tr>
                          </thead>                         
                          <tbody>
                            <?php

                              // recolhe todas as reservas pendentes                              
    ...
    <script>
      $(document).ready(function(){
        ...
        // ao carregar no botao de aceitar
        $('#table').on('click','.botaoA',function () {
          // recolhe id do utilizador
          var v = $(this).data('id');
          // recolhe id de reserva
          var i = $(this).attr('value');        
          var form2 = $('#formtabela');
          // corre api para alterar estado da reserva de "pendente" para "aceite"
          $.ajax({
            type: 'put',
        ...
        // ao carregar no botao de recusar
        $('#table').on('click','.botaoD',function () {
          ...
          var i = $(this).attr('value');
          var form2 = $('#formtabela');
          // corre api para alterar estado da reserva de "pendente" para "recusado"
          $.ajax({
            type: 'put',
