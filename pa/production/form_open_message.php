<?php 
  ...
  // verifica se tem a permissao para ver
  ...
  // verifica se o id do utilizador activo é igual ao id de utilizador desta mensagem
          ...
          <div class="">
            ...
            <div class="title_right">
                <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right">
                  <a href="form_search_messages.php" id="button" type="button"  class="btn btn-primary botao" ><i class="fa fa-arrow-left"></i>  Voltar pagina anterior</a>
                </div>
              </div>
