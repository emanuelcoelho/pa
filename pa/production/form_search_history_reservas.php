  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <?php
          // recolhe id do utilizador atraves de url 
          $id = $_GET['var']; 
          // recolhe informacoes do utilizador
          $query1 = "SELECT *
                    FROM user
                    WHERE id = '$id'";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Histórico de reservas de <?php echo $utilizador; ?> <small>Seleccione a reserva que pretende visualizar</small> </h2>

                    <div class="title_right">
                      <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right">
                        <!-- botao de pagina anterior -->
                        <a href="form_search_history_user.php" id="button" type="button"  class="btn btn-primary botao" ><i class="fa fa-arrow-left"></i>  Voltar pagina anterior</a>
                      </div>
                    </div>
                        ...
                        <table id="table" class="table table-striped table-bordered bulk_action dt-responsive text-center nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <?php
                              ...
                              // recolhe todas as reservas do utilizador                              
    ...
    $(document).ready(function(){
      ...
      $('#table').on('click','.botao',function () {
        ...
        var v = $(this).data('id');
        // abre pagina da reserva        
        if (v != undefined && v != null) {
          window.location = '/pa/production/form_history_reservas.php?var=' + v;
        }
      });
    });
    </script>
