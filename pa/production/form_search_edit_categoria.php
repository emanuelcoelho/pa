          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Editar Categoria <small>Insira as informações necessárias</small></h2>
                        ...
                        <!--<table id="example" class="display" cellspacing="0" width="100%"> -->
                          ...
                          <tbody>
                            <?php
                              ...
                              $query = "SELECT * FROM teste_fkey WHERE id>1";
    ...
    $(document).ready(function(){
     ...
     $(".botao").click(function(){ // Click to only happen on announce links
      ...
      if (v != undefined && v != null) {
          window.location = '/pa/production/form_edit_categoria.php?var=' + v;
      }
