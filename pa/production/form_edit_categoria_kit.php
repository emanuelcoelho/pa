          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Editar categoria de kit <small>Insira as informações necessárias (campos com <span style="color:red">*</span> são obrigatórios!)</small></h2>
                    <div class="title_right">
                      <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right">
                        <!-- botao pagina anterior -->
                        <a href="form_search_edit_categoria_kit.php" id="button" type="button"  class="btn btn-primary botao" ><i class="fa fa-arrow-left"></i>  Voltar pagina anterior</a>
                      </div>
                    </div>
                  ...
                  <div class="x_content">
                    ...
                    <!-- form -->
                    <form id="demo-form2" action="http://myslimsite/api/formCatEdit/updateKit" method="post"  class="form-horizontal form-label-left" >

                      <?php
                        // recolhe o id da categoria seleccionada atraves do url
                        $id = $_GET['var'];
                        // recolhe informacoes necessarias da categoria utilizando o id da categoria
                        $query2 = "SELECT * FROM `categoria_kit` WHERE `id`='$id' ";
        ...
        $(function() {
          ...
          {  
            ...
            $.ajax({
              ...
              processData:false,
              success: function(data) {
                // mensagem de alerta a avisar se foi feita mudanca ou nao 
                alert(data);
                // refresh da pagina
                location.reload();
              }
