              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="http://myslimsite/api/formCatEdit/update" method="post"  class="form-horizontal form-label-left" >

                      <?php
                            $id = $_GET['var'];
                            $query2 = "SELECT * FROM `teste_fkey` WHERE `id`='$id' "; // Run your query
